...
namespace SalesWebMvc.Data
{
    ...
    {
        // Definição do 'SalesWebMvcContext'
        private SalesWebMvcContext _context;

        // Construtor recebendo um objeto do tipo context para indicar que a injeção de dependencia deve acontecer
        public SeedingService(SalesWebMvcContext context)
        {
            // Desta forma o context da classe vai receber o context que chegou como argumento
            _context = context;
        }

        // Método responsavel por popular a base de dados 
        // Seed (neste contexto significa popular)
        public void Seed()
        {
            // Testa se existe algum dado na tabela 'Department', 'Seller' ou 'SalesRecord' e caso exista 
            // não é populada nenhuma tabela
            ...
            // Adiciona os registros de vendas
            ...
            // Adiciona os objetos no banco de dados por meio do 'Entity Framework'
            ...
            // Salva e confirma as alterações do banco de dados
